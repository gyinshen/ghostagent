...
def generate_report_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Using the above information, answer the following'\
           ...
           "(very important!) Make sure to cite information using source urls after the reference. If the provided information refer to multiple subjects with the same name, write separate answers for each subject."\
